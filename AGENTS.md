...
You click "Record," perform a workflow in your browser, and FlowShot automatically captures each action as a step with an annotated screenshot and description. You can edit the guide, replay it on a live page, or export it as a file.
...
Instead of sending screenshots to the AI for step descriptions, FlowShot extracts a lightweight DOM context (~50-100 tokens) from around the target element:
