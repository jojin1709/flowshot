...
│   ├── content.ts           # Content script: event capture + DOM context extraction
...
| Export | [jsPDF](https://github.com/parallax/jsPDF) + [docx](https://github.com/dolanmiu/docx) + HTML/Markdown |
